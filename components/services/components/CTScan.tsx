...
export default function CTScan() {
  return (
    <section id='ct-scan' className='ct-scan pt-16 xl:pt-24'>
      <Container>
        <div className='relative flex flex-wrap items-center'>
          ...
          <div className='relative z-[1] overflow-visible md:flex md:w-1/2 md:flex-initial md:px-4'>
            ...
            <div className='banner-img z-50'>
              <Image
                src='https://res.cloudinary.com/matec-technology-services/image/upload/v1675691229/radsync/jonathan-borba-v_2FRXEba94-unsplash_twrvzj.jpg'
