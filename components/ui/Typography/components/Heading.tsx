...
export const H1: React.FC<H1Props> = ({ children, className, ...rest }) => {
  return (
    <h1 className={clsxm('text-5xl font-bold leading-[3rem] text-headings', className)} {...rest}>
      {children}
    </h1>
  );
};
...
export const H2: React.FC<H2Props> = ({ children, className, ...rest }) => {
  return (
    <h2 className={clsxm('text-4xl font-bold leading-10 text-headings', className)} {...rest}>
      {children}
    </h2>
  );
};
...
export const H3: React.FC<H3Props> = ({ children, className }) => {
  return <h3 className={clsxm('text-3xl font-bold text-headings', className)}>{children}</h3>;
};
...
export const H4: React.FC<H4Props> = ({ children, className, ...rest }) => {
  return (
    <h4 className={clsxm('text-2xl font-bold text-headings', className)} {...rest}>
      {children}
    </h4>
  );
};
...
export const H5: React.FC<H5Props> = ({ children, className, ...rest }) => {
  return (
    <h5 className={clsxm('text-xl font-bold text-headings', className)} {...rest}>
      {children}
    </h5>
  );
};
...
export const H6: React.FC<H6Props> = ({ children, className, ...rest }) => {
  return (
    <h6 className={clsxm('text-lg font-bold text-headings', className)} {...rest}>
      {children}
    </h6>
  );
};
